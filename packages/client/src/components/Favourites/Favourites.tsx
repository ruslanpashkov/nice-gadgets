...
export const Favourites: FC = () => {
  ...
  return (
    <div className="Favourites">
      <nav className="Favourites__breadcrumbs">
        <Breadcrumbs />
      </nav>
      ...
      {hasLikedProducts && (
        <p className="Favourites__items">{likedProducts.length} items</p>
      )}

      {!hasLikedProducts && (
        <h2 className="Favourites__empty-message">No products found</h2>
      )}
